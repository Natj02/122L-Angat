...
export default function Register() {
  ...
  const handleSignUp = async (e) => {
    ...
    if (error) {
      ...
      sessionStorage.setItem("fromPage", "/register");
      ...
      <div className="flex w-[80%] max-w-2/3 bg-primary shadow-2xl rounded-3xl overflow-hidden">
        ...
        <div className="flex flex-col justify-center w-full lg:w-1/2 p-10 relative">
          ...
          <form className="space-y-5" onSubmit={handleSignUp}>
            ...
            <button
              type="submit"
              className="cursor-pointer w-full py-3 bg-secondary text-white font-semibold rounded-lg hover:bg-pink-800 transition"
            >
              Register
            </button>
          </form>
