    ...
    return (
        ...
        <aside className='grid-flow-col items-center self-center'>
          <div className='w-12 h-12 p-1 bg-base-100 rounded-lg'>
            <img src={angatLogo} alt="" />
          </div>
          <p>
            Angat Cembo is a non-government organization based in Cembo, Taguig City.
          </p>
        </aside>
        <nav>
          ...
          <div class="grid grid-flow-col gap-4">
            ...
            <a href="https://www.facebook.com/angatcembocommunityinc">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
      ...
      <footer className="footer footer-horizontal footer-center bg-primary brightness-90 text-base-100 p-6">
        <aside>
