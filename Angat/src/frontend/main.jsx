      ...
      <AuthProvider>
        <Routes>
          ...
          <Route
            path="/success-page"
            element={
              <PrivateRedirectRoute allowedFrom="/create-pass">
                <SuccessPage />
              </PrivateRedirectRoute>
            }
          />
          ...
          <Route
            path="/confirm-email"
            element={
              <PrivateRedirectRoute allowedFrom="/register">
                <ConfirmEmailLanding />
              </PrivateRedirectRoute>
            }
          />
          ...
          <Route path="/" element={<Base />}>
            ...
            <Route element={<PrivateRoleRoute allowedRoles={["admin"]} />}>
            ...
            <Route
              element={<PrivateRoleRoute allowedRoles={["admin", "user"]} />}
            >
